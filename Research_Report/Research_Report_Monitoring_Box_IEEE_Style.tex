...
\author{
	...
	\and
		...
		\and
			...
			\IEEEauthorblockA{Electric\&IT Media Engineering\\Seoul National University\\
...
\par
The "Linked sensor data" paper describes an example of publishing sensor data to an open data database\footnote{ http://linkeddata.org/} where a large amount of datasets are available. This can be used to see the possibilities of how geolocation  data can be published and shared.
\par
...
\section{Methods}
	In order to conduct the research a prototype is created that can be reproduced multiple times. During the research process further modifications have been applied to the prototype. In order to complete the research the following steps have been taken:
		\begin{enumerate}
		...
		\subsection{Research}
			...
			Third, in order to research the question 'How can the data be made available in such a way that the students \& researchers can use it?' desk research is used. Similar cases have been studied and considered selecting the most appropriate way of data sharing and how researchers use open source and data gathering platforms. \\
		\paragraph{Interview setup\\}
		The interviews were executed in the following order:
			\begin{enumerate}
				\item \textbf{Give the participant general introduction of project to participant.} \\
				Describe the goal, what is being researched  and what is going to be done.
				\item \textbf{Let the participant assemble hardware and upload software.}\\
				Of the MonitoringBox. While the participant is doing the assembly of the prototype the participant is being  observed.
				...
				So that the participant will use all the different features of the software and the participant can be observed.
...
\section{Results}
	...
	\begin{figure}[ht]
		...
		\begin{tabular}{ | l | r | l | }
			...
			Student			& 4			& See figure 4 for details \\ \hline \hline
			Total			& 6			& \\ \hline
		\end{tabular}
	...
	\end{figure} \\
			...
			\item How technical are the students and researchers?
				...
				\begin{enumerate}
					\item Researcher A\\
						...
						Afterwards the researcher has mentioned that the following elements are needed in the document.\\
						The following elements were suggested by the researcher, starting with the fact that it should mention in the manual how to use a breadboard and how the structure of breadboard functions. \\
						Then she suggested that it could have more information about the Arduino nano and Arduino uno.\\
					...
					The researcher has mentioned that the following elements in the document are needed.\\
					First, he suggested that it is mentioned in the manual how to upload and where to see the results. \\
					Second, he suggested links to tutorials about the breadboard.\\
					Third, he suggested to put the technical names in the shopping list in order to ease the buying of hardware.\\
					Fourth, he suggested that it is being explained in the manual what the error messages mean and how to solve them instead of only mentioning that there's a possibility of having error messages.\\
					...
					The researcher has mentioned that the following elements are needed in the document.\\
		...
		\begin{figure*}[!ht]
			...
			Student F		& Didn't know when to push	& Didn't know what the which	& Didn't know when to push	& Looks fine, however a	\\ 
...
\\
 	...
 	\end{enumerate}
\section{Conclusion}
	We start doing research because researchers pointed out they are missing open source solutions to perform participatory mapping using one or multiple sensors and map it with a geographical location attached to the measurements. We as researchers conducted research on the way the Monitoring Box should be open sourced and which documentation should be present in a way that both designers and researchers can reproduce their own Monitoring Box or even elaborate on the product and further develop it. \\
	There has been studied what factors contribute to creating an open source, multi-research, sensor geolocation aware, data gathering platform that can be used by the students and researchers. Also six students and two researchers are interviewed and asked which factors of the Monitoring Box are helpful and what other factors are need for. Proven is that the factor that has the biggest impact is the quality of the manual and having error-free code. For the quality of the manual, as the research has demonstrated, not everyone has basic technical knowledge of how to use certain parts, depending on the level of skill. The requirements of each part is different. Therefore, everything should be carefully explained. \\
	Also researched is the usability with the structure plane of user experience. This means there was focus on how the usability of the product could improve. When taken into account the structure plane of user experience, the order of events in the manual is logical to the order of events that happen when assembling. \\
	In the end is research researched how the data can be made available in a way that the students and researchers can use it easily. Also studied is how people prefer to use data and what an easy way to analyse data is. Based on the findings, it is then applied in the Monitoring Box and interviewed people on the product. It is clear to gather data to analyse and store the data in a convenient way the using the Web Interface which must allow access anywhere at any time.\\
...
\section{Future works}
	In order for this study to be deeper, it needs the following future works. \\
	...
	Third, there might have been further research conducted on  the following topic and this is something that should be done as further research: "How can the data be made available such that the students \& researchers can use it?" Having more time to think about this research question will help you validate and improve the usability of the Monitoring Box.\\
	Fourth, the design parts could have been developed further. The Monitoring Box is equipped with various sensors as well as Global Positioning System. Since user have to carry around, a design that allows users to more easily use the Monitoring Box needs to be researched.\\
