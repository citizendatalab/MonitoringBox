...
\section{Future works}
	...
	Fourth, we can develop the design part. The Monitoring Box is equipped with various sensors as well as Global Positioning System. Since user have to carry around, a design that allows users to more easily use the Monitoring Box needs to be researched.\\
